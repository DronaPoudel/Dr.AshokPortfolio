...
<?php include './include/dm.php' ?>

<section class="breadcrumb p-0 position-relative gall-header">
        <!-- <img class = "bread-img" src="./Assets/pgraphy.jpg" alt=""> -->
            <div class="container my-5">
            <div class="bc-content">
                <h1 id = "height-check1" class = "Monotype-Corsiva text-start d-block">Ashok Photography</h1>
            </div>
            </div>
    </section>
<div class="gallery">
